...
class Header extends React.Component {
    ...
    searchHandle = (target) => {
        ...
        if (window.location.pathname === '/search') {
            target.value.length === 0 &&
                this.routingFunction('/react-tubi-tv/');
            // return
        }
    ...
    render() {
        ...
        return (
            <header
                className={cx('header', 'white-bg', 'flex')}
                //   {`header white-b1g flex`}
            >
                <div className="logo flex">
                    {/* <Link to="/react-tubi-tv/">
                        <svg
                            alt="Stream Full Length Series &amp; Movies"
                    ...
                    <div className="register-wrap">
                        {props.isLogged ? (
                            <div className="welcome flex">
                                <div class="_3tRfC">{`Hi, ${props.currUser.name}`}</div>
