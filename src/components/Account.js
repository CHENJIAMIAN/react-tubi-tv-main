        ...
        return (
            <div class="_3taaI">
                <div class="app">
                    ...
                    <div class="Container">
                        <div>
                            <div class="Row _284B9">
                                <div class="Col Col--9 Col--lg-6 Col--xxl-4 _2EqeJ">
                                    <div class="_1QmrE _3BUwb">
                                        <div class="oHtFA"></div>
                                        <h1>My Account</h1>
                                        <div class="SWd1x">
                                            <div class="b5-q0">
                                                <img src="https://cdn.adrise.tv/tubitv-assets/img/default_profile_pic.png"></img>
                                            </div>
                                            <div class="_2kWKE">
                                            ...
                                            <div class="_2Jdp1">
                                                <div class="_3qNWf">
                                                    <p>
                                                        ...
                                                        from Tubi will remove
                                                        your list and history
                                                        and unlink the devices
                                                        associated with it.
                                                    </p>
                                                    <p>
                                                        Please allow up to 48
                                                        hours before your
                    ...
                    <div class="_2IQWz">
                        <div class="Container container">
                            <div class="Row _20pdU">
                                <div class="_1Ubk_">
                                    <a class="ATag _2CQSo" href="/home">
                                        <svg
                                            class="_2rWrR _3GE7h _3K8H0"
                                ...
                                <div class="_23TJ8"></div>
                                <div class="Col Col--4 Col--lg-3 Col--xl-1-5 Col--xxl-2 _3O4gj">
                                    <div class="_3Rq0D">
                                        <div class="SPKaS">
                                            <a
                            ...
                            <div class="Row vCrxD">
                                <div class="Col Col--4 Col--lg-3 Col--xl-1-5 Col--xxl-2 _1kFxu"></div>
                                <div class="Col Col--4 Col--lg-3 Col--xl-1-5 Col--xxl-2 _1kFxu"></div>
                            </div>
                            <div class="Row _3bXfc">
                                <div class="Col Col--4 Col--lg-3 Col--xl-1-5 Col--xxl-2">
                                    <ul class="_1FwaP">
                                        <li class="_1VwYJ">COMPANY</li>
                                        <li>
                                            {' '}
                                            <a
                                ...
                                <div class="Col Col--4 Col--lg-3 Col--xl-1-5 Col--xxl-2">
                                    <ul class="_1FwaP">
                                        <li class="_1VwYJ">GET THE APPS</li>
                                        <li>
                                            <a
                            ...
                            <div class="MsUIH">
                                ...
                                <div class="_34g8g">
                                    <div class="_1qFIf">
                                        ...
                                        <div>
                                            Tubi is a registered trademark of
                                            Tubi, Inc. <br /> All rights
                                            reserved.
                                        </div>
                                    </div>
                                    <div class="XJ_r0">
                                        Device ID:
                                        37611f93-1966-4b56-b828-f5fb779a42b0
                                    </div>
                                </div>
                                <div class="_2PMG5">
                                    Made with{' '}
